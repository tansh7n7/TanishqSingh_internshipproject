                            ...
                            return (<tr className='border-bottom' key={item?.id}>
                                ...
                                <td className='text-center'>
                                    <div className='d-flex align-items-center'>
                                        <BsCurrencyRupee size={20} />{item?.price}
                                    </div>
                                </td>
                                <td className='text-center'>
                        ...
                        {(cart.length > 0) && <>
                            <tr>
                                ...
                                <th className='border-bottom'>
                                    <div className='d-flex align-items-center text-center'>
                                        <BsCurrencyRupee size={21} />{yourCart?.subTotal?.toFixed(2)}
                                    </div>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th className='border-bottom'>
                                    <div className='d-flex align-items-center text-center'>
                                        <BsCurrencyRupee size={21} />{yourCart?.gstAmount?.toFixed(2)}
                                    </div>
                                </th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th className='border-bottom'>
                                    <div className='d-flex align-items-center text-center'>
                                        <BsCurrencyRupee size={21} />{yourCart?.grandTotal?.toFixed(2)}
                                    </div>
                                </th>
                            </tr>
                            <tr>
